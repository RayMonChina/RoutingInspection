...
import com.ideal.zsyy.utils.BitmapCache;
import com.ideal.zsyy.utils.BitmapCache.ImageCallback;
...
//					path, Res.getDrawableID("plugin_camera_camera_default"), 100, 100);
		...
		ImageItem currItem=dataList.get(position);
		boolean isAlreadySelect=false;
		for(ImageItem itm:selectedDataList)
		{
			if(itm.imagePath.equalsIgnoreCase(currItem.imagePath))
			{
