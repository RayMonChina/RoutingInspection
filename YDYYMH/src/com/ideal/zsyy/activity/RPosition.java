...
public class RPosition extends Activity implements BaiduMap.OnMapClickListener, OnGetRoutePlanResultListener {
	...
	private LinearLayout ac_main_bmap_toolbar;
	Polyline mPolyline;
	...
	private void initData() {
		...
		if(intent_pre!=null)
		{
			currLocation=new RLocationInfo();
			currLocation.setLat(intent_pre.getDoubleExtra("lat",0));
			currLocation.setLon(intent_pre.getDoubleExtra("lon",0));
		}
	...
	private void initView() {
		...
		ac_main_bmap_toolbar=(LinearLayout)findViewById(R.id.ac_main_bmap_toolbar);
		ac_main_bmap_toolbar.setVisibility(View.GONE);
		if (bmapsView != null) {
	...
	public void onGetDrivingRouteResult(DrivingRouteResult result) {
		...
		if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
			Toast.makeText(RPosition.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
		}
	...
	private void getTrackPoints() {
		if (!HttpUtil.checkNet(RPosition.this)) {
			Toast.makeText(RPosition.this, "请检查网络！", Toast.LENGTH_SHORT).show();
			return;
		}
		final DialogCirleProgress dCirleProgress = new DialogCirleProgress(RPosition.this);
		...
		.addParams("userid", userId)
				...
				.execute(new Callback<List<RLocationInfo>>() {
					...
					public void onError(Call arg0, Exception arg1, int arg2) {
						...
						Toast.makeText(RPosition.this, "获取用户位置失败！：" + arg1.getMessage(), Toast.LENGTH_SHORT)
								.show();
						return;
					}
					...
					public void onResponse(List<RLocationInfo> arg0, int arg1) {
						...
						dCirleProgress.hideProcessDialog();
						if (arg0 == null) {
							Toast.makeText(RPosition.this, "获取用户位置失败", Toast.LENGTH_SHORT).show();
							return;
						}
						locationPoints=arg0;
						drawTrack();
