...
import com.ideal.zsyy.adapter.AlbumGridViewAdapter;
import com.ideal.zsyy.utils.AlbumHelper;
import com.ideal.zsyy.utils.Bimp;
import com.ideal.zsyy.utils.ImageBucket;
...
public class AlbumActivity extends Activity {
	...
	private String pClassName = "";// 上一级Activity类名
	...
	private class AlbumSendListener implements OnClickListener {
		public void onClick(View v) {
			...
			try {
				intent.setClass(mContext, Class.forName(pClassName));
				startActivity(intent);
			} catch (Exception e) {
	...
	private class BackListener implements OnClickListener {
		public void onClick(View v) {
			...
			intent.putExtra("className", pClassName);
			startActivity(intent);
			finish();
		}
	}
	...
	private void init() {
		...
		pClassName = intent.getStringExtra("className");
	}
				...
				.setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
					...
					public void onItemClick(final ToggleButton toggleButton,
						...
						if (isChecked) {
							...
							if(imgItem!=null)
							{
								for(ImageItem img:Bimp.tempSelectBitmap)
								{
									if(imgItem.imagePath.equalsIgnoreCase(img.imagePath))
									{
										Bimp.tempSelectBitmap.remove(img);
										break;
									}
								}
							}
